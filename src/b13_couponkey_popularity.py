...
detail_cp = detail_cp.sort_values("count")
...
pop_key1_train = pd.merge(coupons, popular_key_train, how='left', left_on='key1', right_index=True)["key_mean"].values
pop_key1_test = pd.merge(coupons, popular_key, how='left', left_on='key1', right_index=True)["key_mean"].values
